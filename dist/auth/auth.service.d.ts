...
export declare class AuthService {
    ...
    findAllEmailEstilista(): Promise<import("src/users/entities/user.entity").UserTimely[]>;
    findAllEmailEmpleado(): Promise<import("src/users/entities/user.entity").UserTimely[]>;
    findByAdministrador(email: string): Promise<import("src/users/entities/user.entity").UserTimely>;
